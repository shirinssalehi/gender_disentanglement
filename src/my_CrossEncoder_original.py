...
class OriginalCrossEncoder():
    def __init__(self, model_name:str, num_labels:int = None, max_length:int = None, device:str = None, tokenizer_args:Dict = {},
        ...
        self.model = OriginalModel(model_name)
    ...
    def fit(self,
        ...
        # file_to_write = open("../data/losses_disen_gender_dim20.txt", "a")
            ...
            for features, relevance_labels, attribute_labels in tqdm(train_dataloader, desc="Iteration", smoothing=0.05, disable=not show_progress_bar):
                if use_amp:
                    ...
                    if training_steps % 1000 ==0:
                        ...
                        print("loss ranking: {}".format(loss_ranking), "\n\n")
                ...
                # training_steps += 1
                # if training_steps % 1000 ==0:
                #     file_to_write.write("loss value: {} \n".format(loss_value))
    ...
    def predict(self, sentences: List[List[str]],
        ...
        with torch.no_grad():
            for features in iterator:
                model_predictions = self.model(features)
                ranking_logits = activation_fct(model_predictions)
                if disen:
                    attribute_logits = activation_fct(model_predictions)
        ...
        return pred_scores, pred_attributes
